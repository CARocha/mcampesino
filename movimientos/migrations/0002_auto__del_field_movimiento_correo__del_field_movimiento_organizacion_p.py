...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Movimiento.correo'
        db.delete_column('movimientos_movimiento', 'correo')

        # Deleting field 'Movimiento.organizacion_persona'
        db.delete_column('movimientos_movimiento', 'organizacion_persona')

        # Deleting field 'Movimiento.telefono'
        db.delete_column('movimientos_movimiento', 'telefono')


    def backwards(self, orm):
        # Adding field 'Movimiento.correo'
        db.add_column('movimientos_movimiento', 'correo',
                      self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Movimiento.organizacion_persona'
        raise RuntimeError("Cannot reverse this migration. 'Movimiento.organizacion_persona' and its values cannot be restored.")
        # Adding field 'Movimiento.telefono'
        db.add_column('movimientos_movimiento', 'telefono',
