...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RegistroMercado.fkregistro'
        db.add_column('mercado_registromercado', 'fkregistro',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mercado.Registro']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RegistroMercado.fkregistro'
        db.delete_column('mercado_registromercado', 'fkregistro_id')
