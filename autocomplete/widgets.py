...
import operator, mcampesino.settings
...
class ForeignKeySearchInput( forms.HiddenInput ):
	...
	def label_for_value( self, value ):
		...
		return obj.__unicode__() # modificado por helmy para mostrar concatenados
			...
			for f in qs[0:10]:
				...
				for field in fields:
					...
					if len( parts )>1:
						...
						s='%s'% f.__unicode__() # ajustado helmy para concatenar datos
